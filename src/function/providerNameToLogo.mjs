        ...
        case "World Air Quality Index Project":
            switch (version) {
                case "v1":
                    ...
                    break;
                case "v2":
                    providerLogo = `https://raw.githubusercontent.com/sddpljx/WeatherKit/main/images/icon/${version}/WAQI.png`;
                    break;
            }
            break;
        case "ColofulClouds":
        case "彩云天气":
            providerLogo = `https://raw.githubusercontent.com/sddpljx/WeatherKit/main/images/icon/${version}/ColorfulClouds.png`;
            break;
        case "气象在线":
        case "WeatherOL":
            providerLogo = `https://raw.githubusercontent.com/sddpljx/WeatherKit/main/images/icon/${version}/WeatherOL.png`;
            break;
        case "QWeather":
        case "和风天气":
